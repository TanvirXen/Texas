...
<Card style={{filter:'drop-shadow(0px 2px 8px rgba(0, 0, 0, 0.08))',borderRadius:'8px',marginTop:'16px',cursor:'pointer'}} key={bid} onClick={()=>Router.push({
    pathname: 'updates/'+bid
})}>
